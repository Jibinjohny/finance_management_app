...
class AppLocalizationsTe extends AppLocalizations {
  ...
  @override
  String get termsAndConditions => 'నియమ నిబంధనలు';
  ...
  @override
  String get whyNeedSignup => 'నేను ఎందుకు సైన్ అప్ చేయాలి?';
  ...
  @override
  String get financialPlanning => 'ఆర్థిక ప్రణాళిక';

  @override
  String get budgets => 'బడ్జెట్‌లు';
  ...
  @override
  String get recurring => 'పునరావృతమయ్యే';
  ...
  @override
  String get noAccountsYet => 'ఇంకా ఖాతాలు లేవు';

  @override
  String get overview => 'అవలోకనం';

  @override
  String get topExpenses => 'అగ్ర ఖర్చులు';
  ...
  @override
  String get noRecentTransactions => 'ఇటీవలి లావాదేవీలు లేవు';

  @override
  String get filterByTags => 'ట్యాగ్‌ల ద్వారా ఫిల్టర్ చేయండి';

  @override
  String get clear => 'క్లియర్ చేయండి';

  @override
  String get noTagsAvailable => 'ట్యాగ్‌లు అందుబాటులో లేవు';
  ...
  @override
  String get deleteTransaction => 'లావాదేవీని తొలగించండి';

  @override
  String deleteTransactionConfirmation(Object title) {
    return 'మీరు ఖచ్చితంగా \"$title\"ని తొలగించాలనుకుంటున్నారా?';
  }
  ...
  @override
  String get incomeVsExpense => 'ఆదాయం vs ఖర్చు';

  @override
  String get financialTrend => 'ఆర్థిక ధోరణి (గత 6 నెలలు)';

  @override
  String get totalIncome => 'మొత్తం ఆదాయం';

  @override
  String get totalExpense => 'మొత్తం ఖర్చు';

  @override
  String get totalBalance => 'మొత్తం బ్యాలెన్స్';

  @override
  String get spendingByTags => 'ట్యాగ్‌ల ద్వారా ఖర్చు';

  @override
  String get accountBreakdown => 'ఖాతా వివరాలు';

  @override
  String get noAccountsFound => 'ఖాతాలు కనుగొనబడలేదు';
  ...
  String get privacyContactContent =>
      'ఈ గోప్యతా విధానం గురించి మీకు ఏవైనా ప్రశ్నలు ఉంటే, దయచేసి యాప్ యొక్క మద్దతు విభాగం ద్వారా మమ్మల్ని సంప్రదించండి.';

  @override
  String get addTransactionTitle => 'లావాదేవీని జోడించండి';

  @override
  String get editTransactionTitle => 'లావాదేవీని సవరించండి';
  ...
  @override
  String get chooseDate => 'తేదీని ఎంచుకోండి';

  @override
  String get saveTransaction => 'లావాదేవీని సేవ్ చేయండి';

  @override
  String get noAccountsMessage =>
      'లావాదేవీని సృష్టించే ముందు మీరు కనీసం ఒక ఖాతాను జోడించాలి.';

  @override
  String get addAccountAction => 'ఖాతాను జోడించండి';

  @override
  String get incomeMessage1 => '🎉 బ్యాంకులో డబ్బు వచ్చింది!';

  @override
  String get incomeMessage2 => '💰 గలగల! డబ్బు వస్తూనే ఉండనివ్వండి!';

  @override
  String get incomeMessage3 => '✨ మీ వాలెట్ సంతోషంగా ఉంది!';

  @override
  String get incomeMessage4 => '🚀 చంద్రుని పైకి!';

  @override
  String get incomeMessage5 => '💸 పోగు చేయండి!';

  @override
  String get incomeMessage6 => '🔥 మీరు అద్భుతంగా ఉన్నారు!';

  @override
  String get incomeMessage7 => '⭐ డబ్బు వర్షం!';

  @override
  String get incomeMessage8 => '💎 డైమండ్ హ్యాండ్స్!';

  @override
  String get addAccountTitle => 'ఖాతాను జోడించండి';

  @override
  String get editAccountTitle => 'ఖాతాను సవరించండి';
  ...
  @override
  String get accountNameHint => 'ఉదా: ప్రధాన వాలెట్';

  @override
  String get accountNameError => 'దయచేసి పేరును నమోదు చేయండి';

  @override
  String get accountTypeLabel => 'ఖాతా రకం';

  @override
  String get initialBalanceLabel => 'ప్రారంభ బ్యాలెన్స్';

  @override
  String get currentBalanceLabel => 'ప్రస్తుత బ్యాలెన్స్';

  @override
  String get creditLimitLabel => 'క్రెడిట్ పరిమితి';

  @override
  String get balanceHint => '0.00';

  @override
  String get balanceError => 'దయచేసి బ్యాలెన్స్‌ను నమోదు చేయండి';

  @override
  String get validNumberError => 'దయచేసి సరైన సంఖ్యను నమోదు చేయండి';

  @override
  String get bankDetails => 'బ్యాంక్ వివరాలు';

  @override
  String get cardDetails => 'కార్డ్ వివరాలు';

  @override
  String get bankNameLabel => 'బ్యాంక్ పేరు';

  @override
  String get cardIssuerLabel => 'కార్డ్ జారీచేసేవారు / బ్యాంక్';

  @override
  String get bankNameHint => 'ఉదా: ఎస్‌బిఐ';

  @override
  String get bankNameError => 'దయచేసి బ్యాంక్ పేరును నమోదు చేయండి';

  @override
  String get cardIssuerError => 'దయచేసి కార్డ్ జారీచేసేవారిని నమోదు చేయండి';

  @override
  String get accountNumberLabel => 'ఖాతా సంఖ్య';

  @override
  String get cardNumberLabel => 'కార్డ్ సంఖ్య (చివరి 4 అంకెలు)';
  ...
  @override
  String get cardNumberError => 'దయచేసి చివరి 4 అంకెలను నమోదు చేయండి';

  @override
  String get cardNumberLengthError => 'దయచేసి ఖచ్చితంగా 4 అంకెలను నమోదు చేయండి';

  @override
  String get loanDetails => 'రుణ వివరాలు';

  @override
  String get loanPrincipalLabel => 'రుణ అసలు';

  @override
  String get loanPrincipalError => 'దయచేసి అసలును నమోదు చేయండి';

  @override
  String get interestRateLabel => 'వడ్డీ రేటు (వార్షిక %)';

  @override
  String get interestRateError => 'దయచేసి వడ్డీ రేటును నమోదు చేయండి';

  @override
  String get loanTenureLabel => 'రుణ కాలపరిమితి (నెలలు)';

  @override
  String get loanTenureError => 'దయచేసి కాలపరిమితిని నమోదు చేయండి';

  @override
  String get emiAmountLabel => 'EMI మొత్తం';

  @override
  String get emiAmountError => 'దయచేసి EMI మొత్తాన్ని నమోదు చేయండి';

  @override
  String get loanStartDateLabel => 'రుణ ప్రారంభ తేదీ';

  @override
  String get emiPaymentDayLabel => 'EMI చెల్లింపు రోజు';

  @override
  String get emisPaidLabel => 'చెల్లించిన EMIలు';

  @override
  String get emisPaidError => 'దయచేసి చెల్లించిన EMIలను నమోదు చేయండి';

  @override
  String get emisPendingLabel => 'పెండింగ్‌లో ఉన్న EMIలు (లెక్కించబడింది)';

  @override
  String get appearanceLabel => 'స్వరూపం';

  @override
  String get colorLabel => 'రంగు';

  @override
  String get iconLabel => 'చిహ్నం';

  @override
  String get createAccountButton => 'ఖాతాను సృష్టించండి';
  ...
  String deleteAccountMessage(String accountName) {
    return 'మీరు ఖచ్చితంగా \"$accountName\"ను తొలగించాలనుకుంటున్నారా? ఈ చర్యను రద్దు చేయలేము.';
  }

  @override
  String deleteAccountWarning(String accountName, int count) {
    return 'మీరు ఖచ్చితంగా \"$accountName\"ను తొలగించాలనుకుంటున్నారా? ఇది దానితో అనుబంధించబడిన $count లావాదేవీలను కూడా తొలగిస్తుంది.';
  }
  ...
  @override
  String get accountUpdatedSuccess => 'ఖాతా విజయవంతంగా నవీకరించబడింది';

  @override
  String accountUpdateError(String error) {
    return 'ఖాతాను నవీకరించడంలో లోపం: $error';
  }
  ...
  @override
  String get accountTypeSavings => 'పొదుపు';

  @override
  String get accountTypeSalary => 'జీతం';

  @override
  String get accountTypeCurrent => 'కరెంట్';
  ...
  @override
  String get accountTypeInvestment => 'పెట్టుబడి';

  @override
  String get accountTypeLoan => 'రుణం';

  @override
  String get accountTypeOther => 'ఇతర';

  @override
  String get selectLabel => 'ఎంచుకోండి';

  @override
  String get changeLabel => 'మార్చండి';
  ...
  @override
  String get step1Title => 'దశ 1 / 2';

  @override
  String get step1Subtitle => 'ప్రాథమిక వివరాలు';

  @override
  String get step2Title => 'దశ 2 / 2';

  @override
  String get step2Subtitle => 'మరిన్ని వివరాలు';

  @override
  String get titleOptionalLabel => 'శీర్షిక (ఐచ్ఛికం)';

  @override
  String get titleHint => 'ఉదా: కిరాణా షాపింగ్';

  @override
  String get nextButton => 'తరువాత';

  @override
  String get selectAccountLabel => 'ఖాతాను ఎంచుకోండి';

  @override
  String get noAccountsAvailable => 'ఖాతాలు ఏవీ అందుబాటులో లేవు';

  @override
  String get selectedLabel => 'ఎంచుకోబడింది';

  @override
  String get tagsLabel => 'ట్యాగ్‌లు';

  @override
  String get addTagLabel => 'ట్యాగ్‌ను జోడించండి';

  @override
  String get notesLabel => 'గమనికలు';

  @override
  String get notesHint => 'ఈ లావాదేవీకి గమనికలను జోడించండి';
  ...
  @override
  String get selectAccountError => 'దయచేసి ఖాతాను ఎంచుకోండి';

  @override
  String get transactionAddedSuccess => 'లావాదేవీ విజయవంతంగా జోడించబడింది!';
